...
export default function PanelEfectoNacional({ datos, showMapa, showCurva, showRadar, showImpacto, showIndicadores }: Props) {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-8">
        {/* Mapa de Perú */}
        <motion.div layout variants={cardIn} initial="hidden" animate={showMapa ? "visible" : "visible"} style={{ opacity: showMapa ? 1 : 0 }}>
          {showMapa ? (
            ...
            <Card className="p-6 flex flex-col items-center justify-center" style={{ height: 340 }}>
              <CargandoAnimado texto="Generando mapa..." />
            </Card>
          )}
        </motion.div>

        {/* Curva de Confianza */}
        <motion.div layout variants={cardIn} initial="hidden" animate={showCurva ? "visible" : "visible"} style={{ opacity: showCurva ? 1 : 0 }}>
          {showCurva ? (
            <Card className="p-4 sm:p-6">
              ...
              <ResponsiveContainer width="100%" height={240}>
                <AreaChart data={datos.serie_temporal}>
                  ...
                  <Area type="monotone" dataKey="recuperacion" stroke="#00C851" strokeWidth={2} fill="url(#gradConfianza)" animationDuration={1500} />
                </AreaChart>
              </ResponsiveContainer>
            </Card>
          ) : (
            <Card className="p-6 flex flex-col items-center justify-center" style={{ minHeight: 280 }}>
              <CargandoAnimado texto="Generando curva..." />
            </Card>
          )}
        </motion.div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
        {/* Radar de sectores */}
        <motion.div layout variants={cardIn} initial="hidden" animate={showRadar ? "visible" : "visible"} style={{ opacity: showRadar ? 1 : 0 }}>
          {showRadar ? (
            <Card className="p-4 sm:p-6">
            ...
            <Card className="p-6 flex flex-col items-center justify-center" style={{ minHeight: 300 }}>
              <CargandoAnimado texto="Generando radar..." />
            </Card>
          )}
        </motion.div>

        {/* Tarjetas de impacto */}
        <motion.div layout variants={cardIn} initial="hidden" animate={showImpacto ? "visible" : "visible"} style={{ opacity: showImpacto ? 1 : 0 }}>
          {showImpacto ? (
            <Card className="p-4 sm:p-6">
            ...
            <Card className="p-6 flex flex-col items-center justify-center" style={{ minHeight: 300 }}>
              <CargandoAnimado texto="Generando impacto..." />
            </Card>
          )}
        </motion.div>

        {/* Métricas nacionales */}
        <motion.div layout variants={cardIn} initial="hidden" animate={showIndicadores ? "visible" : "visible"} style={{ opacity: showIndicadores ? 1 : 0 }}>
          {showIndicadores ? (
            <Card className="p-4 sm:p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="w-full bg-surface rounded-full h-2">
                    <div className="h-2 rounded-full bg-cyan transition-all duration-1000" style={{ width: `${datos.efecto_nacional.confianza_ciudadana_nacional}%` }} />
                  </div>
                ...
                <div>
                  ...
                  <div className="w-full bg-surface rounded-full h-2">
                    <div className="h-2 rounded-full bg-success transition-all duration-1000" style={{ width: `${datos.efecto_nacional.disponibilidad_critica}%` }} />
                  </div>
                ...
                <div>
                  ...
                  <div className="w-full bg-surface rounded-full h-2">
                    <div className="h-2 rounded-full bg-danger transition-all duration-1000" style={{ width: `${datos.parametricas.riesgoGlobal * 100}%` }} />
                  </div>
            ...
            <Card className="p-6 flex flex-col items-center justify-center" style={{ minHeight: 300 }}>
              <CargandoAnimado texto="Generando indicadores..." />
            </Card>
          )}
        </motion.div>
      </div>
